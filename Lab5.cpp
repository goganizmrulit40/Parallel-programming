...
// ============================================================
// ПОСЛЕДОВАТЕЛЬНЫЙ АЛГОРИТМ (КЛАССИЧЕСКИЙ i-j-k, КАК В 1-Й ЛАБЕ)
// ============================================================
...
// ============================================================
// ПАРАЛЛЕЛЬНЫЙ АЛГОРИТМ (MPI, ОПТИМИЗИРОВАННЫЙ i-k-j)
// ============================================================
...
double multiply_mpi(const vector<vector<double>>& A,
    ...
    // Буфер для B создаём на ВСЕХ процессах
...
int main(int argc, char* argv[]) {
    ...
    if (rank == 0) {
        ...
        cout << "Результаты добавляются в " << filename << endl;
        cout << "=========================================================" << endl;
    }
    ...
    if (rank == 0) {
        ...
        cout << "Результаты добавлены в " << filename << endl;
        cout << "=========================================================" << endl;
    }
